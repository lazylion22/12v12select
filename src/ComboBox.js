...
const top100Films = [
  { label: `  "Applause"   "Applause"`,txt: `
  "Applause"   "Applause" -ch 1
`},
{ label: `  "Crash_and_Burn"  "Crash and burn"`,txt: `
  "Crash_and_Burn"  "Crash and burn" -ch 2
`},
{ label: `  "Crickets"   "Crickets"`,txt: `
  "Crickets"   "Crickets" -ch 3
`},
{ label: `  "Party_Horn"   "Party horn"`,txt: `
  "Party_Horn"   "Party horn" -ch 4
`},
{ label: `  "Rimshot"   "Ba-dum tishh"`,txt: `
  "Rimshot"   "Ba-dum tishh" -ch 5
`},
{ label: `  "Charge"    "Charge"`,txt: `
  "Charge"    "Charge" -ch 6
`},
{ label: `  "Drum_Roll"   "Drum roll"`,txt: `
  "Drum_Roll"   "Drum roll" -ch 7
`},
{ label: `  "Frog"    "Frog"`,txt: `
  "Frog"    "Frog" -ch 8
`},
...
{ label: `  "Ow"     "Oww"`,txt: `
  "Ow"     "Oww" -ch 11
`},
{ label: `  "Snore"    "Snore"`,txt: `
  "Snore"    "Snore" -ch 12
`},
{ label: `  "Bockbock"   "Bock bock"`,txt: `
  "Bockbock"   "Bock bock" -ch 13
`},
{ label: `  "Crybaby"   "Crybaby"`,txt: `
  "Crybaby"   "Crybaby" -ch 14
`},
{ label: `  "Sad_Trombone"  "Sad trombone"`,txt: `
  "Sad_Trombone"  "Sad trombone" -ch 15
`},
{ label: `  "Yahoo"    "Yahoo"`,txt: `
  "Yahoo"    "Yahoo" -ch 16
`},
{ label: `  "Sleighbells"   "Sleighbells"`,txt: `
  "Sleighbells"   "Sleighbells" -ch 18
`},
{ label: `  "Sparkling_Celebration" "Sparkling Celebration"`,txt: `
  "Sparkling_Celebration" "Sparkling Celebration" -ch 19
`},
{ label: `  "Greevil_Laughter"  "Greevil Laughter"`,txt: `
  "Greevil_Laughter"  "Greevil Laughter" -ch 20
`},
{ label: `  "Frostivus_Magic"  "Frostivus Magic"`,txt: `
  "Frostivus_Magic"  "Frostivus Magic" -ch 21
`},
{ label: `  "Ceremonial_Drums"  "Ceremonial Drums"`,txt: `
  "Ceremonial_Drums"  "Ceremonial Drums" -ch 22
`},
{ label: `  "Oink_Oink"    "Oink Oink!"`,txt: `
  "Oink_Oink"    "Oink Oink!" -ch 23
`},
{ label: `  "Celebratory_Gong"  "Celebratory Gong"`,txt: `
  "Celebratory_Gong"  "Celebratory Gong" -ch 24
`},
{ label: `  "wow"        "Waow"`,txt: `
  "wow"        "Waow" -ch 26
`},
{ label: `  "all_dead"       "They're all dead!"`,txt: `
  "all_dead"       "They're all dead!" -ch 27
`},
{ label: `  "brutal"        "Brutal. Savage. Rekt."`,txt: `
  "brutal"        "Brutal. Savage. Rekt." -ch 28
`},
{ label: `  "disastah"       "It's a disastah!"`,txt: `
  "disastah"       "It's a disastah!" -ch 29
`},
{ label: `  "oh_my_lord"       "Oh my lord!"`,txt: `
  "oh_my_lord"       "Oh my lord!" -ch 30
`},
{ label: `  "youre_a_hero"      "You're a goddamn hero!"`,txt: `
  "youre_a_hero"      "You're a goddamn hero!" -ch 31
`},
{ label: `  "playing_to_win"      "That's ing to win, baby!"`,txt: `
  "playing_to_win"      "That's ing to win, baby!" -ch 33
`},
{ label: `  "what_just_happened"     "I can't believe what we're seeing. What just happened?"`,txt: `
  "what_just_happened"     "I can't believe what we're seeing. What just happened?" -ch 34
`},
{ label: `  "looking_spicy"      "It's looking Spicy!"`,txt: `
  "looking_spicy"      "It's looking Spicy!" -ch 35
`},
{ label: `  "no_chill"       "This guy has no chill"`,txt: `
  "no_chill"       "This guy has no chill" -ch 36
`},
{ label: `  "ding_ding_ding"      "Ding Ding Ding Mother******"`,txt: `
  "ding_ding_ding"      "Ding Ding Ding Mother******" -ch 37
`},
{ label: `  "absolutely_perfect"     "Absolutely Perfect"`,txt: `
  "absolutely_perfect"     "Absolutely Perfect" -ch 38
`},
{ label: `  "lets_play"       "Let's Play Some Dota"`,txt: `
  "lets_play"       "Let's Play Some Dota" -ch 39
`},
{ label: `  "wan_bu_liao_la"      "玩不了啦!"`,txt: `
  "wan_bu_liao_la"      "玩不了啦!" -ch 41
`},
{ label: `  "po_liang_lu"      "破两路更好打, 是吧?"`,txt: `
  "po_liang_lu"      "破两路更好打, 是吧?" -ch 42
`},
{ label: `  "tian_huo"       "天火!"`,txt: `
  "tian_huo"       "天火!" -ch 43
`},
{ label: `  "jia_you"       "加油!"`,txt: `
  "jia_you"       "加油!" -ch 44
`},
{ label: `  "zou_hao_bu_song"     "走好, 不送"`,txt: `
  "zou_hao_bu_song"     "走好, 不送" -ch 45
`},
{ label: `  "liu_liu_liu"      "这波不亏"`,txt: `
  "liu_liu_liu"      "这波不亏" -ch 46
`},
{ label: `  "ni_qi_bu_qi"      "你气不气?"`,txt: `
  "ni_qi_bu_qi"      "你气不气?" -ch 48
`},
{ label: `  "gao_fu_shuai"      "这就是高富帅啊"`,txt: `
  "gao_fu_shuai"      "这就是高富帅啊" -ch 49
`},
{ label: `  "gan_ma_ne_xiong_di"     "干嘛呢兄弟"`,txt: `
  "gan_ma_ne_xiong_di"     "干嘛呢兄弟" -ch 50
`},
{ label: `  "bai_tuo_shei_qu"     "拜托谁去杀了他吧"`,txt: `
  "bai_tuo_shei_qu"     "拜托谁去杀了他吧" -ch 51
`},
{ label: `  "piao_liang"       "漂~ 亮！"`,txt: `
  "piao_liang"       "漂~ 亮！" -ch 52
`},
{ label: `  "lian_dou_xiu_wai_la"    "脸都秀歪啦"`,txt: `
  "lian_dou_xiu_wai_la"    "脸都秀歪啦" -ch 53
`},
{ label: `  "zai_jian_le_bao_bei"    "再见了宝贝儿！"`,txt: `
  "zai_jian_le_bao_bei"    "再见了宝贝儿！" -ch 54
`},
{ label: `  "zhil_do_konsta"      "Жил до конца, умер как герой"`,txt: `
  "zhil_do_konsta"      "Жил до конца, умер как герой" -ch 56
`},
{ label: `  "ay_ay_ay"       "Ай-ай-ай-ай-ай, что сейчас произошло!"`,txt: `
  "ay_ay_ay"       "Ай-ай-ай-ай-ай, что сейчас произошло!" -ch 57
`},
{ label: `  "ehto_g_g"       "Это ГГ"`,txt: `
  "ehto_g_g"       "Это ГГ" -ch 58
`},
{ label: `  "eto_prosto_netchto"     "Это. Просто. Нечто."`,txt: `
  "eto_prosto_netchto"     "Это. Просто. Нечто." -ch 59
`},
{ label: `  "krasavchik"       "Красавчик!"`,txt: `
  "krasavchik"       "Красавчик!" -ch 60
`},
{ label: `  "bozhe_kak_eto_bolno"    "Боже, как это больно!"`,txt: `
  "bozhe_kak_eto_bolno"    "Боже, как это больно!" -ch 61
`},
{ label: `  "eto_nenormalno"      "Это ненормально, это нечестно!"`,txt: `
  "eto_nenormalno"      "Это ненормально, это нечестно!" -ch 63
`},
{ label: `  "eto_sochno"       "Как же это сочно, ах!"`,txt: `
  "eto_sochno"       "Как же это сочно, ах!" -ch 64
`},
{ label: `  "kreasa_kreasa"      "Резать Резать Резать Резать"`,txt: `
  "kreasa_kreasa"      "Резать Резать Резать Резать" -ch 65
`},
{ label: `  "kak_boyge_te_byechenya"    "Какой же ты бешеный, а"`,txt: `
  "kak_boyge_te_byechenya"    "Какой же ты бешеный, а" -ch 66
`},
{ label: `  "eto_ge_popayx_feeda"    "Это уже попахивает фидом"`,txt: `
  "eto_ge_popayx_feeda"    "Это уже попахивает фидом" -ch 67
`},
{ label: `  "da_da_da_nyet"      "Да? Да? Да? Нет."`,txt: `
  "da_da_da_nyet"      "Да? Да? Да? Нет." -ch 68
`},
{ label: `  "wot_eto_bru"      "Вот Это Врыв!"`,txt: `
  "wot_eto_bru"      "Вот Это Врыв!" -ch 69
`},
{ label: `  "monkey_biz"       "Monkey Business"`,txt: `
  "monkey_biz"       "Monkey Business" -ch 71
`},
{ label: `  "orangutan_kiss"      "Sloppy Orangutan Kiss"`,txt: `
  "orangutan_kiss"      "Sloppy Orangutan Kiss" -ch 72
`},
{ label: `  "skeeter"       "Mosquito Buzz"`,txt: `
  "skeeter"       "Mosquito Buzz" -ch 73
`},
{ label: `  "crowd_groan"      "Crowd Groan"`,txt: `
  "crowd_groan"      "Crowd Groan" -ch 74
`},
{ label: `  "head_bonk"       "Head Bonk"`,txt: `
  "head_bonk"       "Head Bonk" -ch 75
`},
{ label: `  "record_scratch"      "Record Scratch"`,txt: `
  "record_scratch"      "Record Scratch" -ch 76
`},
{ label: `  "ta_da"        "Ta Daaaaaa"`,txt: `
  "ta_da"        "Ta Daaaaaa" -ch 77
`},
{ label: `  "echo_slama_jama"     "Echo Slamma Jamma!"`,txt: `
  "echo_slama_jama"     "Echo Slamma Jamma!" -ch 79
`},
{ label: `  "next_level"       "The next level!"`,txt: `
  "next_level"       "The next level!" -ch 80
`},
{ label: `  "oy_oy_oy"       "Oyoy oy oy, oy, oy, oy, oy, oy!"`,txt: `
  "oy_oy_oy"       "Oyoy oy oy, oy, oy, oy, oy, oy!" -ch 81
`},
{ label: `  "ta_daaaa"       "Lakad Matataaag! Normalin, Normalin."`,txt: `
  "ta_daaaa"       "Lakad Matataaag! Normalin, Normalin." -ch 82
`},
{ label: ` "ceeb"        "Ceeeeeeeeeeeeb!"`,txt: `
 "ceeb"        "Ceeeeeeeeeeeeb!" -ch 83
`},
{ label: `  "goodness_gracious"     "Sir Chief. Goodness Gracious Papable."`,txt: `
  "goodness_gracious"     "Sir Chief. Goodness Gracious Papable." -ch 84
`},
{ label: `  "whats_cooking"      "You know what's cooking? BOOM!"`,txt: `
  "whats_cooking"      "You know what's cooking? BOOM!" -ch 86
`},
{ label: `  "eughahaha"       "Eughahaha Aah Ha Ha Ha Ha"`,txt: `
  "eughahaha"       "Eughahaha Aah Ha Ha Ha Ha" -ch 87
`},
{ label: `  "glados_chat_21"      "I estimate the probability of winning to be above 99%."`,txt: `
  "glados_chat_21"      "I estimate the probability of winning to be above 99%." -ch 88
`},
{ label: `  "glados_chat_01"      "I'm not angry, I'm Just Disappointed."`,txt: `
  "glados_chat_01"      "I'm not angry, I'm Just Disappointed." -ch 89
`},
{ label: `  "glados_chat_07"      "I estimate the probability of winning to be above 1%."`,txt: `
  "glados_chat_07"      "I estimate the probability of winning to be above 1%." -ch 90
`},
{ label: `  "glados_chat_04"      "I estimate the probability of winning to be 17%."`,txt: `
  "glados_chat_04"      "I estimate the probability of winning to be 17%." -ch 91
`},
{ label: `  "kor_scan"       "스캔 돌려야 되요 따라란따란따라라라란 스캔 돌려야 된다고요!"`,txt: `
  "kor_scan"       "스캔 돌려야 되요 따라란따란따라라라란 스캔 돌려야 된다고요!" -ch 94
`},
{ label: `  "kor_immortality"     "Mommy! I got me! Immortality!"`,txt: `
  "kor_immortality"     "Mommy! I got me! Immortality!" -ch 95
`},
{ label: `  "kor_roshan"       "Roshan! Roshan! Roshan!"`,txt: `
  "kor_roshan"       "Roshan! Roshan! Roshan!" -ch 96
`},
{ label: `  "kor_yolo"       "골드 부활 못 해! YOLO! 골드 부활 못 해! YOLO!"`,txt: `
  "kor_yolo"       "골드 부활 못 해! YOLO! 골드 부활 못 해! YOLO!" -ch 97
`},
{ label: `  "kor_million_dollar_house"   "10억짜리 꿈의 고리! 15억짜리 꿈의 고리!"`,txt: `
  "kor_million_dollar_house"   "10억짜리 꿈의 고리! 15억짜리 꿈의 고리!" -ch 98
`},
